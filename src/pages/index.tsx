  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Analytics Dashboard - Your one-stop solution for network device traffic monitoring. Explore devices, sites, and admin options for detailed time series graphs and device information."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxuZXR3b3JrJTIwZGV2aWNlc3xlbnwwfHx8fDE2OTM4ODk1MTJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Analytics Dashboard - Your one-stop solution for network device traffic monitoring. Explore devices, sites, and admin options for detailed time series graphs and device information.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Network Administrator"
