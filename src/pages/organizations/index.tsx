...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'admin_panel.count', 'device.count', 'site.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('device', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Device',
          accessorKey: 'device',
          cell: ({ row: { original: record } }: any) => record?._count?.device,
        }
      : null,
    hasAccess('site', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Site',
          accessorKey: 'site',
          cell: ({ row: { original: record } }: any) => record?._count?.site,
        }
      : null,
