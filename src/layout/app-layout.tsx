...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['network-administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Devices', path: '/devices', entity: 'device', service: AccessServiceEnum.PROJECT, icon: FiSmartphone },
    { name: 'Sites', path: '/sites', entity: 'site', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
    {
      name: 'Traffic Graphs',
      path: '/traffic-graphs',
